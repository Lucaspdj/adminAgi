...
export class ServicosComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        this.tableData1 = {
            headerRow: [ '#', 'Nome', 'Descrição', 'Ativo', 'Status', 'Tipo','Tipo de serviço','Ações'],
            dataRows: [
                ['1', 'TESTE', 'TESTE', 'TESTE', 'TESTE', 'TESTE','TESTE', 'btn-link'],
                ['2', 'TESTE', 'TESTE', 'TESTE', 'TESTE', 'TESTE','TESTE', 'btn-link'],
                ['3', 'TESTE', 'TESTE', 'TESTE', 'TESTE', 'TESTE','TESTE', 'btn-link'],
            ]
         };
    }
